...
load(url("https://github.com/qpetitjean/MoveR/raw/Main/man/figures/activity2-3Dplot.Rdata"))
    # draw the plot
...
This plot may be helpful as diagnostic plot to check the distribution of the data making the two clusters and to check whether the clusters has been identified in an expected way. 
