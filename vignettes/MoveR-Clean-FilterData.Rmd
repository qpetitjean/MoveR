...
```{r SizeCleanSTR, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r SpeedCleanSTR, echo=TRUE, results='markup', message=FALSE, warning=FALSE}
# display the information about the filtering process (see ??filterTracklets())
...
```{r edgeDefSTR, echo=TRUE, results='markup', message=FALSE, warning=FALSE}
...
```{r edgeCleanSTR, echo=TRUE, results='markup', message=FALSE, warning=FALSE}
# display the information about the filtering process (see ??filterTracklets())
...
```{r edgeCleanAlternativeSTR, echo=TRUE, results='markup', message=FALSE, warning=FALSE}
# display the information about the filtering process (see ??filterTracklets())
