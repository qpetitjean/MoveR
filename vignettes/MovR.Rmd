...
customFuncList = list(
  ...
  actives1 = function(x)
    MovR::actives1(x, minSpeed = 10 ^ activTresh, speedCol = "speed"),
...
Here, we use a step of 10 frame as sliding window to compute the mean sinuosity,
the mean turning angle ans well as the turning angle variance, the mean speed and speed variance, the mean activity as well as the mean proportion of time spent near the edge, the mean distance to the edge and the mean and maximum traveled distance.
