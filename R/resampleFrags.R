...
#'                  timeCol = "frame")
#'
#' # convert the time unit (frame) to seconds using analyseFrags (according to a frame rate of 25 fps)
#' trackListV1 <-
#'   MoveR::analyseFrags(trackList,
#'                       customFunc = list(
...
#' trackListSampled1S <- MoveR::resampleFrags(trackListV1,
#'                                            TimeCol = "TimeSec",
#'                                            Tstep = 1)
#'
...
#' trackListSampled0.10S <- MoveR::resampleFrags(trackListV1,
#'                                               TimeCol = "TimeSec",
#'                                               Tstep = 0.10)
