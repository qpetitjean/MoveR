...
#' 
#' @param scale A Boolean indicating whether the data should be centered (i.e., values minus the mean) and scaled (divided by the standard deviation) (default = TRUE).
#' 
#' @param na.rm A Boolean indicating whether NA values should be stripped before the computation proceeds (default = TRUE).
#'
...
#' MoveR::drawFrags(trackdat3,
#'           cex.start = 0.1,
#'           add2It = list(for (i in seq_along(trackdat3)) {
#'             points(
#'               trackdat3[[i]][["x.pos"]][which(trackdat3[[i]][["actives2"]] == "inactive")],
#'               trackdat3[[i]][["y.pos"]][which(trackdat3[[i]][["actives2"]] == "inactive")],
#'               col = "red",
#'               pch = 19,
#'               cex = 1.5
#'             )
